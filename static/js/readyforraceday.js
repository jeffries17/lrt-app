...
function calculateReadinessFun() {
  ...
  // Update result card with general information
  ...
  // Display results
  document.getElementById('resultHeader').innerText = resultHeaderText;
  document.getElementById('resultText').innerText = resultBodyText;
...
function calculateReadinessTime() {
  ...
  // Update result card with advanced information
  ...
  resultText += `\n\nAdditional Details for Racing for Time:\nCurrent Time: ${currentPace}\nGoal Time: ${goalPace}\nTraining Days per Week: ${trainingDays}`;

  // Display results
  document.getElementById('resultHeader').innerText = resultHeader;
